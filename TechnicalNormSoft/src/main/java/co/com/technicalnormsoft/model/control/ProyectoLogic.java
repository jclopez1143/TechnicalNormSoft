    ...
    */
    ...
    public void saveProyecto(Proyecto entity) throws Exception {
        ...
        try {
            ...
            if (getProyecto(entity.getIdProyecto()) != null) {
    ...
    public void deleteProyecto(Proyecto entity) throws Exception {
        ...
        try {
            programas = programaDAO.findByProperty("proyecto.idProyecto",
            ...
            proyectoEstablecimientos = proyectoEstablecimientoDAO.findByProperty("proyecto.idProyecto",
                    entity.getIdProyecto());
    ...
    //Method finds Proyecto by ProyectoEstablecimiento id
    @Transactional(readOnly = true)
    public Proyecto findProyectoByProyectoEstablecimientoId(Integer proyectoEstablecimientoId) 
    		throws Exception {
        log.debug("getting Proyecto instance");
        ...
        try {
            entity = proyectoDAO.findProyectoByProyectoEstablecimientoId(proyectoEstablecimientoId);
        } catch (Exception e) {
            log.error("get Proyecto failed", e);
            throw new ZMessManager().new FindingException("Proyecto");
        } finally {
    ...
    //Method finds Proyecto by Norma id
    @Transactional(readOnly = true)
    public Proyecto findProyectoByNormaId(Integer idNorma) throws Exception {
        ...
        try {
            entity = proyectoDAO.findProyectoByNormaId(idNorma);
        } catch (Exception e) {
            log.error("get Proyecto failed", e);
            throw new ZMessManager().new FindingException("Proyecto");
        } finally {
